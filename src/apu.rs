...
pub fn step_channel_1(emulator: &mut Emulator) {
    let period_divider_increment = (emulator.cpu.clock.instruction_clock_cycles / 4) as u16; 
    emulator.apu.ch1_period_divider -= period_divider_increment;
    if emulator.apu.ch1_period_divider == 0 {
        ...
        emulator.apu.ch1_period_divider = new_period;
    }
}
